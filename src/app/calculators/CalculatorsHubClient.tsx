...
const toolGroups: ToolGroup[] = [
  ...
  },
  {
    ...
    intro: "Use these when you need to turn numbers into a clearer meeting output.",
    tools: [
      {
      ...
      },
      {
        ...
        description: "Shape a deck request from your brief, template choice and supporting data.",
        href: "/custom-deck",
        cta: "Build custom deck",
        preview: "Brief + template -> meeting-ready deck",
        keywords: ["custom deck", "deck", "presentation", "brief", "templates"],
      },
      {
        title: "Buyer meeting prep",
        description: "Create a practical meeting prep outline from objectives, asks and risks.",
        href: "/tools/buyer-meeting-prep",
        cta: "Prep buyer meeting",
        preview: "Objective -> ask -> next steps",
        keywords: ["buyer", "meeting", "prep", "agenda", "planning"],
      },
      {
        title: "Template library",
        description: "Browse downloadable planning templates and commercial meeting structures.",
        href: "/templates",
        cta: "Browse library",
        preview: "Plans, reviews and proposal outlines",
        keywords: ["templates", "library", "planning", "downloads", "presentation"],
      },
    ],
  },
];
