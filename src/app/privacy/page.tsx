...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for NAM Tools, including browser-based tools and contact email handling.",
};
...
export default function Page() {
  return (
    <LegalPage
      title="Privacy policy"
      intro="This privacy policy explains how NAM Tools handles information."
      body={[
