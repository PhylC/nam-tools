  ...
  return (
    <LegalPage
      ...
      body={[
        ...
        "If GA4 analytics is enabled, Account Planning Tools may collect public page views and basic feature events. Analytics events are not intended to include calculator inputs, commercial values, scenario names, email addresses or user IDs.",
        "If you use saved plans, saved deck briefs, checkout or email capture, those services may process the information needed to provide the feature.",
