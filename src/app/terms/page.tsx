...
export const metadata: Metadata = {
  title: "Terms of Use",
  description:
    "UK-oriented terms for NAM Tools, a general commercial planning toolkit for account managers.",
};
...
export default function Page() {
  return (
    <LegalPage
      title="Terms of use"
      intro="These terms explain how to use NAM Tools."
      body={[
        ...
        "We may change, remove or improve pages, tools, formulas and content as the product develops.",
      ]}
    />
  );
}
